    ...
    return (
        <div className="flex flex-col bg-transparent">
            ...
            <div className="flex items-center justify-between mb-2 p-2">
                <p className="text-white font-light">WorkPlace</p>
                ...
                <Accordion type="single" collapsible defaultValue={activeOrg ? activeOrg : undefined}>
                    {organizations.map((org) => (
                        <AccordionItem key={org.id} value={org.id}>
                            ...
                            <AccordionTrigger
                                className={`flex items-center justify-between p-2 text-lg font-semibold text-gray-700 hover:bg-[#e6f6fd6a] hover:no-underline cursor-pointer ${org.id === activeOrg ? "bg-[#E6F6FD]" : "text-white"}`}
                            >
                                <div className="flex items-center space-x-4">
                                    {/* Organization Image */}
                                    <Image src="/orgicon.png" alt="orgimg" width={25} height={25} />
                                    <span className="text-black font-light text-sm hover:no-underline">{org.name}</span>
                                </div>
                            </AccordionTrigger>
                            ...
                            <AccordionContent>
                                <div className="flex justify-center">
                                    <div className="space-y-2 px-3 py-2 text-white">
                                        {/* Board Link */}
                                        <span
                                            onClick={() => { handleLinkClick(org.id, ""); }}
                                            className={`block hover:bg-black px-2 py-1 rounded-md ${org.id === activeOrg && currentPage === "" ? "text-black bg-black" : ""}`}
                                        >
                                        ...
                                        <span
                                            ...
                                            className={`block hover:bg-black px-2 py-1 rounded-md ${org.id === activeOrg && currentPage === "settings" ? "text-black bg-[#E6F6FD]" : ""}`}
                                        >
                                            <div className="flex items-center space-x-2 cursor-pointer">
                                                {/* Icon for Settings */}
                                        ...
                                        <span
                                            ...
                                            className={`block hover:bg-black px-2 py-1 rounded-md ${org.id === activeOrg && currentPage === "members" ? "text-black bg-[#E6F6FD]" : ""}`}
                                        >
                                            <div className="flex items-center space-x-2 cursor-pointer">
                                                {/* Icon for Members */}
                                        ...
                                        <span
                                            ...
                                            className={`block hover:bg-black px-2 py-1 rounded-md ${org.id === activeOrg && currentPage === "calendar" ? "text-black bg-[#E6F6FD]" : ""}`}
                                        >
                                            <div className="flex items-center space-x-2 cursor-pointer">
                                                {/* Icon for Calendar */}
                                        ...
                                        <span
                                            ...
                                            className={`block hover:bg-black px-2 py-1 rounded-md ${org.id === activeOrg && currentPage === "table" ? "text-black bg-[#E6F6FD]" : ""}`}
                                        >
                                            <div className="flex items-center space-x-2 cursor-pointer">
                                                {/* Icon for Table */}
